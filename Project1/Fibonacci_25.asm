...
.data
fibs:.word   0 : 25         # "array" of words to contain fib values            Edited: We allocate enough space for 25 entries.
size: .word  25             # size of "array" (agrees with array declaration)	Edited: Variable holding size of the array is now 25
