...
.data
fibs:.word   0 : 17         # "array" of words to contain fib values            Edited: We allocate enough space for 17 entries.
size: .word  17             # size of "array" (agrees with array declaration)	Edited: Variable holding size of the array is now 17
